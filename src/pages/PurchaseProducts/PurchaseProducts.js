          ...
          <div className="col-md-6">
            ...
            <div className="d-flex justify-content-center">
              ...
              <form className="pt-3 pb-5" onSubmit={handleSubmit(onSubmit)}>
                <input
                  className="mx-3 my-2 w-75 px-4 py-2"
                ...
                {/* order status */}
                <input
                  className="mx-3 my-2 w-25 px-4 py-2"
                ...
                {/* submit button */}
                <input
                  className="d-block mx-auto mx-3 my-2 btn btn-info w-75"
                  type="submit"
                  value="Order Now"
                />
                ...
                <NavLink
                  to="/home"
                  className=" text-decoration-none d-block mx-auto mx-3 my-2 btn btn-outline-success w-75"
                >
                  {" "}
                  Choose Another Fragrance
                </NavLink>
              </form>
            </div>
          </div>
